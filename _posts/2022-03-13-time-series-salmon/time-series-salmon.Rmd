...
description: |
  Adult fish passage at Willamette Falls fish ladder visualization through time series analysis.
author:
  - name: Renee Lamanna
    url: {}
date: 2022-03-13
...
```{r}
# Read in the data
fish <- read_csv(here("_posts", "data", "willamette_fish_passage.csv")) %>% 
  janitor::clean_names()
